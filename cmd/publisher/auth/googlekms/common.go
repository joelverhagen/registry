...
func (g *GoogleKMSSigner) GetSignedTimestamp(ctx context.Context) (*string, []byte, error) {
	...
	fmt.Println("Executing the sign request...")
	switch algo {
...
func (g *GoogleKMSSigner) showPublicKeyAndGetAlgorithm(ctx context.Context, client *kms.KeyManagementClient) (auth.CryptoAlgorithm, error) {
